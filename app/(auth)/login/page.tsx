  ...
  return (
    <div className="flex-1 flex flex-col px-6 pt-10">
      ...
      <div className="flex items-center gap-3 my-6">
        <div className="flex-1 h-px" style={{ backgroundColor: '#E0D8D0' }} />
        <span className="text-sm" style={{ color: '#6B6560' }}>atau</span>
        <div className="flex-1 h-px" style={{ backgroundColor: '#E0D8D0' }} />
      </div>
      ...
      <button
        ...
        className="w-full h-12 rounded-xl flex items-center justify-center gap-3 font-medium text-sm transition-all active:scale-[0.98]"
        style={{ border: '1.5px solid #E0D8D0', backgroundColor: '#fff', color: '#1A1A1A' }}
      >
        ...
        {tab === 'daftar' ? 'Daftar dengan Google' : 'Masuk dengan Google'}
      </button>

      <p className="text-center text-xs mt-8 mb-4" style={{ color: '#6B6560' }}>
        Gratis untuk pasangan Indonesia
      </p>
    </div>
  )
}
